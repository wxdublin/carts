...
public class Task {
	...
	public Task(Task task){
		...
		this.exe = task.getExe();
		this.deadline = task.getDeadline();
		this.delta_rel = task.getDelta_rel();
		this.delta_sch = task.getDelta_sch();
		this.delta_cxs = task.getDelta_cxs();
	...
	public Task(double period, double exe, double deadline){
		...
		if(exe == deadline){
			Tool.debug("ATTENTION: task's execution == deadline!\r\n");
		}
		this.name = "default";
		this.period = period;
