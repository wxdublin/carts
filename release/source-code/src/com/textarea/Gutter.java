...
public class Gutter extends JComponent implements SwingConstants {
	...
	protected void paintLineNumbers(Graphics gfx) {
		...
		int baseline = (int) Math.round((this.baseline + lineHeight - pfm
				.getMaxDescent()) / 2.0);
		...
		for (int line = firstLine; line <= lastLine; line++, baseline += lineHeight) {
			...
			case RIGHT:
				...
				break;
			case CENTER:
				offset = ((gutterSize.width - collapsedSize.width) - fm
						.stringWidth(number)) / 2;
				break;
			case LEFT:
			default:
				offset = 1;
	...
	class GutterMouseListener extends MouseAdapter implements
			MouseMotionListener {
