...
/*
 * ChangeLog: $Log: SyntaxDocument.java,v $ Revision 1.14 1999/12/13 03:40:30 sp
 * Bug fixes, syntax is now mostly GPL'd
 * 
 * Revision 1.13 1999/12/10 03:22:47 sp Bug fixes, old loading code is now used
 * again
 * 
 * Revision 1.12 1999/12/07 08:16:55 sp Reload bug nailed to the wall
 * 
 * Revision 1.11 1999/11/07 06:51:43 sp Check box menu items supported
 * 
 * Revision 1.10 1999/10/24 02:06:41 sp Miscallaneous pre1 stuff
 * 
 * Revision 1.9 1999/09/30 12:21:05 sp No net access for a month... so here's
 * one big jEdit 2.1pre1
 * 
 * Revision 1.8 1999/07/05 04:38:39 sp Massive batch of changes... bug fixes,
 * also new text component is in place. Have fun
 * 
 * Revision 1.7 1999/06/22 06:14:39 sp RMI updates, text area updates, flag to
 * disable geometry saving
 * 
 * Revision 1.6 1999/06/07 06:36:32 sp Syntax `styling' (bold/italic tokens)
 * added, plugin options dialog for plugin option panes
 * 
 * Revision 1.5 1999/06/05 00:22:58 sp LGPL'd syntax package
 * 
 * Revision 1.4 1999/05/02 00:07:21 sp Syntax system tweaks, console bugfix for
 * Swing 1.1.1
 * 
 * Revision 1.3 1999/04/19 05:38:20 sp Syntax API changes
 */
