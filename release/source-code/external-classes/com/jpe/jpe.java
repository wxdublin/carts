...
public class jpe extends JFrame implements ActionListener, MouseListener,
	 ...
	 */
	private ComponentArea Editors[] = new ComponentArea[99];
	 ...
	 */
	private JMenuItem jmiAlgoPeriodic, jmiAlgoEDP, jmiAlgoDPRM,jmiAlgoMPR,jmiAlgoEQV;
	...
	public jpe() {
		...
		algoMenu.add(jmiAlgoEQV = MenuFactory.createMenuItem("compute EQV interface", null,
				null, 0, 0, this));
		algoMenu.add(jmiAlgoDPRM = MenuFactory.createMenuItem("compute DPRM interface", null,
				null, 0, 0, this));
		algoMenu.add(jmiAlgoDPRM = MenuFactory.createMenuItem("compute CADPRM_TASKCENTRIC interface", null,
				null, 0, 0, this));
		algoMenu.add(jmiAlgoDPRM = MenuFactory.createMenuItem("compute CADPRM_MODELCENTRIC interface", null,
				null, 0, 0, this));
		algoMenu.add(jmiAlgoDPRM = MenuFactory.createMenuItem("compute CADPRM_HYBRID interface", null,
				null, 0, 0, this));
...
//		jmiAlgoSirap.setEnabled(true);
	...
	public void actionPerformed(ActionEvent e) {
		...
		} else if (e.getSource() == jmiAlgoDPRM) {
			Editors[selectedTabIndex()].getTreeArea().processDPRM();
