 ...
 * 
 * @author Slava Pestov
 * @version $Id: DefaultInputHandler.java,v 1.20 2000/02/12 03:56:58 sp Exp $
 */
	...
	public void keyTyped(KeyEvent evt) {
		...
		if (c != KeyEvent.CHAR_UNDEFINED
			...
			if (c >= 0x20 && c != 0x7f) {
				...
				executeAction(inputAction, evt.getSource(), String.valueOf(evt
						.getKeyChar()));
...
/*
 * ChangeLog: $Log: DefaultInputHandler.java,v $ Revision 1.20 2000/02/12
 * 03:56:58 sp 2.3pre5 stuff
 * 
 * Revision 1.19 1999/12/19 11:14:29 sp Static abbrev expansion started
 * 
 * Revision 1.18 1999/12/13 03:40:30 sp Bug fixes, syntax is now mostly GPL'd
 * 
 * Revision 1.17 1999/12/03 23:48:10 sp C+END/C+HOME, LOADING BufferUpdate
 * message, misc stuff
 * 
 * Revision 1.16 1999/11/16 08:21:20 sp Various fixes, attempt at beefing up
 * expand-abbrev
 * 
 * Revision 1.15 1999/11/09 10:14:34 sp Macro code cleanups, menu item and tool
 * bar clicks are recorded now, delete word commands, check box menu item
 * support
 * 
 * Revision 1.14 1999/10/26 07:43:59 sp Session loading and saving, directory
 * list search started
 * 
 * Revision 1.13 1999/10/24 02:06:41 sp Miscallaneous pre1 stuff
 * 
 * Revision 1.12 1999/10/17 04:16:28 sp Bug fixing
 * 
 * Revision 1.11 1999/10/10 06:38:45 sp Bug fixes and quicksort routine
 * 
 * Revision 1.10 1999/10/06 08:39:46 sp Fixes to repeating and macro features
 * 
 * Revision 1.9 1999/10/05 10:55:29 sp File dialogs open faster, and
 * experimental keyboard macros
 * 
 * Revision 1.8 1999/10/05 04:43:58 sp Minor bug fixes and updates
 * 
 * Revision 1.7 1999/10/04 06:13:52 sp Repeat counts now supported
 * 
 * Revision 1.6 1999/09/30 12:21:05 sp No net access for a month... so here's
