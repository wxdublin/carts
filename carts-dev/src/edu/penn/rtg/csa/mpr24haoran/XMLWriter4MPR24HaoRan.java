...
public class XMLWriter4MPR24HaoRan {
	...
	public XMLWriter4MPR24HaoRan(String outputFilename, Component rootComponent){
		try{
	...
	public static void main(String[] args) {
		...
		try{
			XMLInterpreter4MPR24HaoRan xmlInputParse = new XMLInterpreter4MPR24HaoRan("CAMPR-input.xml");		
			xmlInputParse.parseFile();
			Component rootComponent = xmlInputParse.getRootComponent();
			XMLWriter4MPR24HaoRan xmlOutputOriginalComponentTree = new XMLWriter4MPR24HaoRan("CAMPR-component-output.xml", rootComponent);
			XMLWriter4MPR24HaoRan xmlOutputInterfaceTree = new XMLWriter4MPR24HaoRan("CAMPR-interface-output.xml", rootComponent);
