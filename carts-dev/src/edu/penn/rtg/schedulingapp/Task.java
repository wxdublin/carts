...
public class Task extends DefaultMutableTreeNode {
	...
	public boolean update(Task task)
	{
		...
		if(this.delta_rel != task.delta_rel){
			this.delta_rel = task.delta_rel;
			isUpdated = true;
		}
		if(this.delta_sch != task.delta_sch){
			this.delta_sch = task.delta_sch;
			isUpdated = true;
		}
		if(this.delta_cxs != task.delta_cxs){
			this.delta_cxs = task.delta_cxs;
			isUpdated = true;
		}
		if(this.delta_crpmd != task.delta_crpmd){
			this.delta_crpmd = task.delta_crpmd;
			isUpdated = true;
		}
		return isUpdated;
	}
	...
	public void convertToXML(StringBuffer buffer) {
		...
		buffer.append(" p=\"" + (double) period + "\"");
		buffer.append(" d=\"" + (double) deadline + "\"");
		...
		if(this.delta_rel!=0)
		{
			buffer.append(" delta_rel=\"" + (double) this.delta_rel + "\"");
		}
		if(this.delta_sch!=0)
		{
			buffer.append(" delta_sch=\"" + (double) this.delta_sch + "\"");
		}
		if(this.delta_cxs!=0)
		{
			buffer.append(" delta_cxs=\"" + (double) this.delta_cxs + "\"");
		}
		if(this.delta_crpmd!=0)
		{
			buffer.append(" delta_crpmd=\"" + (double) this.delta_crpmd + "\"");
		}
		buffer.append("></task>\n");
	}
	...
	public String getResult() {
		...
		if(this.period != 0 && this.execution != 0 && this.deadline != 0 ){
