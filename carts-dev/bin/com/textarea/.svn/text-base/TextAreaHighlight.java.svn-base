...
/**
 * Highlight interface. Create implementations of this interface and add them to
 * the text area with <code>TextAreaPainter.addCustomHighlight()</code> to paint
 * custom highlights.
 * 
 * @author Slava Pestov
 * @version $Id: TextAreaHighlight.java,v 1.1 2000/01/29 10:12:43 sp Exp $
 */
