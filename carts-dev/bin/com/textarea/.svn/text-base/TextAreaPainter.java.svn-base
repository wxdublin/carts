 ...
 * 
 * @author Slava Pestov
 * @version $Id: TextAreaPainter.java,v 1.25 2000/01/29 10:12:43 sp Exp $
 */
...
/*
 * ChangeLog: $Log: TextAreaPainter.java,v $ Revision 1.25 2000/01/29 10:12:43
 * sp BeanShell edit mode, bug fixes
 * 
 * Revision 1.24 1999/12/13 03:40:30 sp Bug fixes, syntax is now mostly GPL'd
 * 
 * Revision 1.23 1999/12/11 06:34:39 sp Bug fixes
 * 
 * Revision 1.22 1999/12/07 07:19:36 sp Buffer loading code cleaned up
 * 
 * Revision 1.21 1999/11/28 00:33:07 sp Faster directory search, actions slimmed
 * down, faster exit/close-all
 * 
 * Revision 1.20 1999/11/26 01:18:50 sp Optimizations, splash screen updates,
 * misc stuff
 * 
 * Revision 1.19 1999/11/21 03:40:18 sp Parts of EditBus not used by core moved
 * to EditBus.jar
 * 
 * Revision 1.18 1999/11/21 01:20:31 sp Bug fixes, EditBus updates, fixed some
 * warnings generated by jikes +P
 * 
 * Revision 1.17 1999/11/06 02:06:50 sp Logging updates, bug fixing, icons,
 * various other stuff
 * 
 * Revision 1.16 1999/10/06 08:39:46 sp Fixes to repeating and macro features
 * 
 * Revision 1.15 1999/09/30 12:21:05 sp No net access for a month... so here's
 * one big jEdit 2.1pre1
 * 
 * Revision 1.14 1999/08/21 01:48:18 sp jEdit 2.0pre8
 * 
 * Revision 1.13 1999/07/29 08:50:21 sp Misc stuff for 1.7pre7
 * 
 * Revision 1.12 1999/07/16 23:45:49 sp 1.7pre6 BugFree version
 * 
 * Revision 1.11 1999/07/08 06:06:04 sp Bug fixes and miscallaneous updates
 * 
 * Revision 1.10 1999/07/05 04:38:40 sp Massive batch of changes... bug fixes,
 * also new text component is in place. Have fun
 * 
 * Revision 1.9 1999/06/30 07:08:02 sp Text area bug fixes
 * 
 * Revision 1.8 1999/06/30 05:01:55 sp Lots of text area bug fixes and
 * optimizations
 * 
 * Revision 1.7 1999/06/29 09:01:24 sp Text area now does bracket matching, eol
 * markers, also xToOffset() and offsetToX() now work better
 * 
 * Revision 1.6 1999/06/28 09:17:20 sp Perl mode javac compile fix, text area
 * hacking
 * 
 * Revision 1.5 1999/06/27 04:53:16 sp Text selection implemented in text area,
 * assorted bug fixes
 * 
 * Revision 1.4 1999/06/25 06:54:08 sp Text area updates
 */
