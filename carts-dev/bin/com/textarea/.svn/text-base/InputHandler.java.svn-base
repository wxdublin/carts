 ...
 * 
 * @author Slava Pestov
 * @version $Id: InputHandler.java,v 1.21 2000/02/15 07:44:30 sp Exp $
...
public abstract class InputHandler extends KeyAdapter {
		...
		public void actionPerformed(ActionEvent evt) {
			...
			if (caret == 0) {
				...
				String noWordSep = (String) textArea.getDocument().getProperty(
						"noWordSep");
				caret = TextUtilities.findWordStart(lineText, caret - 1,
						noWordSep);
			}
	...
	public static class delete_word implements ActionListener {
		public void actionPerformed(ActionEvent evt) {
			...
			if (caret == lineText.length()) {
				...
				String noWordSep = (String) textArea.getDocument().getProperty(
						"noWordSep");
				caret = TextUtilities.findWordEnd(lineText, caret + 1,
						noWordSep);
			}
	...
	/*
	 * public static class insert_break implements ActionListener { public void
	 * actionPerformed(ActionEvent evt) { JEditTextArea textArea =
	 * getTextArea(evt);
	 * 
	 * if(!textArea.isEditable()) { textArea.getToolkit().beep(); return; }
	 * 
	 * textArea.setSelectedText("\n"); } }
	 * 
	 * public static class insert_tab implements ActionListener { public void
	 * actionPerformed(ActionEvent evt) { JEditTextArea textArea =
	 * getTextArea(evt);
	 * 
	 * if(!textArea.isEditable()) { textArea.getToolkit().beep(); return; }
...
/*
 * ChangeLog: $Log: InputHandler.java,v $ Revision 1.21 2000/02/15 07:44:30 sp
 * bug fixes, doc updates, etc
 * 
 * Revision 1.20 2000/02/10 08:32:51 sp Bug fixes, doc updates
 * 
 * Revision 1.19 2000/01/28 00:20:58 sp Lots of stuff
 * 
 * Revision 1.18 2000/01/21 00:35:29 sp Various updates
 * 
 * Revision 1.16 1999/12/24 01:20:20 sp Bug fixing and other stuff for 2.3pre1
 * 
 * Revision 1.15 1999/12/19 11:14:29 sp Static abbrev expansion started
 * 
 * Revision 1.14 1999/12/13 03:40:30 sp Bug fixes, syntax is now mostly GPL'd
 * 
 * Revision 1.13 1999/12/03 23:48:10 sp C+END/C+HOME, LOADING BufferUpdate
 * message, misc stuff
 * 
 * Revision 1.12 1999/11/21 07:59:30 sp JavaDoc updates
 * 
 * Revision 1.11 1999/11/21 03:40:18 sp Parts of EditBus not used by core moved
 * to EditBus.jar
 * 
 * Revision 1.10 1999/11/21 01:20:31 sp Bug fixes, EditBus updates, fixed some
 * warnings generated by jikes +P
 * 
 * Revision 1.9 1999/11/19 08:54:52 sp EditBus integrated into the core, event
 * system gone, bug fixes
 * 
 * Revision 1.8 1999/11/16 08:21:20 sp Various fixes, attempt at beefing up
 * expand-abbrev
 * 
 * Revision 1.7 1999/11/09 10:14:34 sp Macro code cleanups, menu item and tool
 * bar clicks are recorded now, delete word commands, check box menu item
 * support
 * 
 * Revision 1.6 1999/10/24 02:06:41 sp Miscallaneous pre1 stuff
 * 
 * Revision 1.5 1999/10/05 10:55:29 sp File dialogs open faster, and
 * experimental keyboard macros
 */
