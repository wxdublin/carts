...
public class SyntaxUtilities {
	...
	public static SyntaxStyle[] getDefaultSyntaxStyles() {
		...
		styles[Token.COMMENT1] = new SyntaxStyle(new Color(0, 128, 0), true,
				false);
		styles[Token.COMMENT2] = new SyntaxStyle(new Color(0, 128, 0), true,
				false);
		styles[Token.KEYWORD1] = new SyntaxStyle(Color.blue, false, false);
		styles[Token.KEYWORD2] = new SyntaxStyle(new Color(189, 0, 168), false,
				false);
		styles[Token.KEYWORD3] = new SyntaxStyle(Color.red, false, false);
		styles[Token.LITERAL1] = new SyntaxStyle(new Color(3, 173, 251), false,
				false);
...
/*
 * ChangeLog: $Log: SyntaxUtilities.java,v $ Revision 1.9 1999/12/13 03:40:30 sp
 * Bug fixes, syntax is now mostly GPL'd
 * 
 * Revision 1.8 1999/07/08 06:06:04 sp Bug fixes and miscallaneous updates
 * 
 * Revision 1.7 1999/07/05 04:38:39 sp Massive batch of changes... bug fixes,
 ...
 * 
 * Revision 1.4 1999/04/19 05:38:20 sp Syntax API changes
 * 
 * Revision 1.3 1999/04/02 02:39:46 sp Updated docs, console fix,
 * getDefaultSyntaxColors() method, hypersearch update
 * 
 * Revision 1.2 1999/03/27 02:46:17 sp SyntaxTextArea is now modular
 * 
