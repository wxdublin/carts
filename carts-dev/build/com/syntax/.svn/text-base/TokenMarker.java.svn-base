...
/*
 * ChangeLog: $Log: TokenMarker.java,v $ Revision 1.32 1999/12/13 03:40:30 sp
 * Bug fixes, syntax is now mostly GPL'd
 * 
 * Revision 1.31 1999/12/10 03:22:47 sp Bug fixes, old loading code is now used
 * again
 * 
 * Revision 1.30 1999/12/07 07:27:59 sp TokenMarker.reset() fixed
 * 
 * Revision 1.29 1999/12/07 07:19:36 sp Buffer loading code cleaned up
 * 
 * Revision 1.28 1999/07/29 08:50:21 sp Misc stuff for 1.7pre7
 * 
 * Revision 1.27 1999/07/16 23:45:49 sp 1.7pre6 BugFree version
 * 
 * Revision 1.26 1999/07/05 04:38:39 sp Massive batch of changes... bug fixes,
 * also new text component is in place. Have fun
 * 
 * Revision 1.25 1999/06/06 05:05:25 sp Search and replace tweaks, Perl/Shell
 * Script mode updates
 * 
 * Revision 1.24 1999/06/05 00:22:58 sp LGPL'd syntax package
 * 
 * Revision 1.23 1999/05/03 08:28:14 sp Documentation updates, key binding
 * editor, syntax text area bug fix
 * 
 * Revision 1.22 1999/05/03 04:28:01 sp Syntax colorizing bug fixing, console
 * bug fix for Swing 1.1.1
 * 
 * Revision 1.21 1999/05/02 00:07:21 sp Syntax system tweaks, console bugfix for
 * Swing 1.1.1
 */
